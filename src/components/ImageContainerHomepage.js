...
const ImageContainerHomepage = () => {
  return (
    <div className='containerr'>
        <h2 className=''><span className='text-primary'>TITLE</span> - Our Latest Car</h2>
        <div className='sm:flex gap-[5vw]'>
            ...
            <div className='sm:w-1/2'>
              <img className='w-full h-full object-cover bg-[#D9D9D9]' src='./images/sample-pic.jpg' alt="image"></img>
            </div>
        </div>
    </div>
  )
